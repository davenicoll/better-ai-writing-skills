...
dest="$repo_root/plugins/better-ai-writing-skills/skills/better-ai-writing-skills/SKILL.md"
...
plugin_version="$(
  python3 - "$repo_root/plugins/better-ai-writing-skills/.claude-plugin/plugin.json" <<'PY'
import json
import sys
